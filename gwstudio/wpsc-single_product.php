...
<section class="top-sec clearfix">
  <section class="commission-desk border">
     <img src="<?php bloginfo('template_directory'); ?>/images/owl-icon.gif" alt="" class="left-img" />
     <p>Owl Furniture&reg; was developed in 2009 by Geoffrey Warner in response to a new and challenging economy. These designs stem from a core philosophy that honors Community, Ecology and Economy. By offering kits and workshops as well as finished furniture we are able to reach out to many more people interested in owning something beautiful, comfortable and handmade. We are always interested in your ideas and observations. You can reach us at <a href="mailto:info&#64;geoffreywarnerstudio.com">info&#64;geoffreywarnerstudio.com</a>.</p>
  </section>
...
<div id="single_product_page_container" class="clearfix">
...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					<div class="imagecol left-area">
						<?php if ( wpsc_the_product_thumbnail() ) : ?>
								<a title="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?>" href="<?php echo wpsc_the_product_image(); ?>">
								...
								if ( function_exists( 'gold_shpcrt_display_gallery' ) ) ?>
									<div id="prod-thumbs">
									<!--<a href="#" class="arrow-left"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-left-sm.gif" alt="" /></a> <a href="#" class="arrow-right"><img src="<?php bloginfo('template_directory'); ?>/images/arrow-right-sm.gif" alt="" /></a>-->
					...
					<div class="productcol right-area">			
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php if(wpsc_has_multi_adding()): ?>
                            	<fieldset class="qty"><legend><?php _e('Quantity', 'wpsc'); ?></legend>
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									...
									<?php if(wpsc_show_pnp()) : ?>
										<p class="pricedispla" style="display:none;"><?php _e('Shipping', 'wpsc'); ?>:<span class="pp_price"><?php echo wpsc_product_postage_and_packaging(); ?></span></p>
									<?php endif; ?>							
								<?php endif; ?>
