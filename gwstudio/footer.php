<?php /* mods:
27Dec16 zig - use current year for copyright date.
 */ ?>
<?php $social_options = get_option( 'sandbox_theme_social_options' ); ?>
      <footer>
        ...
        <p class="copyright">Copyright &copy; <?php echo date('Y'); ?> Geoffrey Warner Studio Designed by Iana CraneWing and built by <a href="http://www.xhtml-lab.com" rel="external">XHTML Lab</a></p>
      </footer>
    </div>
