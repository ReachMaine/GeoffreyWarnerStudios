...
<div class="my_meta_control">
    ...
    <div class="opt-buttons">
      <p><a href="#" class="docopy-form_page button">Add Image Group</a></p>
      <p><a href="#" class="dodelete-form_page button">Remove All</a></p>
    </div>
    
    <div class="saperator"></div>
 
    <?php while($mb->have_fields_and_multi('form_page')): ?>
