...
<h1 class="cart_heading"><?php _e('YOUR SHOPPING CART', 'wpsc'); ?></h1>
<h4 style="font-size:15px; text-align:center; margin:0 0 20px 0; color:#ff0000;">If you encounter any problem checking out please do not hesitate to call us during business hours<br/>
Mon. - Fri. 9-5 EST.  207-367-6555  Thank you for your order!
</h4>
         ...
         <?php if (!wpsc_have_shipping_quote()) : // No valid shipping quotes ?>
            <?php if (wpsc_have_valid_shipping_zipcode()) : ?>
                  <tr class='wpsc_update_location'>
                     <td colspan='5' class='shipping_error' style="display:none;" >
...
?>
      ...
      <tr>
            <td colspan='2'>
                <label for="agree"> You may visit our <a href="<?php echo home_url(); ?>/policies">Policies</a> page to learn about how we handle shipping and returns.</label>
               </td>
         </tr>
      </table>
      ...
      <?php if(wpsc_uses_shipping()) : ?>
	      <tr>
	         <td class='wpsc_total_price_and_shipping'colspan='2'>
	            <h4 class="highlight_red"><?php _e('Review & Purchase','wpsc'); ?></h4>
                <p class="review-txt">We'll do our best to have your order ready as soon as possible, but our policy is to ship orders within two to eight weeks of receiving payment. We will provide you with tracking information as soon as your order has shipped.<br /><br />Tax is automatically included in the total price if you live in Maine. Non-Maine residents will not be taxed.</p>
	         </td>
	      </tr>
   ...
   <tr>
	         <td class='wpsc_total_price_and_shipping'colspan='2'>
                <p class="review-txt" style="font-weight:bold;">When you click BuyNow you will be directed to the PayPal website where you can pay securely even if you do not have a PayPal account</p>
	         </td>
	      </tr>
   </table>
